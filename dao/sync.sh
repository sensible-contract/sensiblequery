...
echo "loading data"
clickhouse-client -h $DBHOST --database="bsv" --query="INSERT INTO blk_height_new FORMAT RowBinary"   < ~/astudy/blkparser/out/blk.ch
clickhouse-client -h $DBHOST --database="bsv" --query="INSERT INTO blktx_height_new FORMAT RowBinary" < ~/astudy/blkparser/out/tx.ch
clickhouse-client -h $DBHOST --database="bsv" --query="INSERT INTO txin_new FORMAT RowBinary"         < ~/astudy/blkparser/out/txin.ch
clickhouse-client -h $DBHOST --database="bsv" --query="INSERT INTO txout_new FORMAT RowBinary"        < ~/astudy/blkparser/out/txout.ch
